...
validateCodebook <- function(codebookUrl, datasetNames) {
  for (dataset in datasetNames) {
    process_dataset(codebookUrl, dataset, c("Analytic Variable name", "Analytic Variable label", "catValues", "numRange",
                                            "uniqueKey", "essential", "acceptableMissingness", "nonExtremeMissingness",
                                            "missingnessThresholdMultiplier", "skipLogic"))
  }
}