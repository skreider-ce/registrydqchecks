...
updatePackages <- function(snapshot = TRUE){
  remotes::install_github("skreider-ce/registrydqchecksreportdown@*release", dependencies = TRUE) # Most up to date static package release
  remotes::install_github("skreider-ce/registrydqchecks@*release", dependencies = TRUE) # Most up to date static package release
