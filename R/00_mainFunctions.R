...
#'
#' @export
copyDatasetsToLocation <- function(.datasetsToCopy, .prelimDataFolderUrl, .prelimDataPullDate, .folderToCopyTo, .remove = FALSE){
  for(.dsName in .datasetsToCopy){
    copyDataset(.dataSetToCopy = glue::glue("{.prelimDataFolderUrl}{.dsName}_{.prelimDataPullDate}")
